        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
          <div className="lg:col-span-2 flex justify-center">
            <div className="relative">
              <div className="w-48 h-48 rounded-2xl overflow-hidden glow-border relative z-10">
                <img
          ...
          <div className="lg:col-span-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {highlights.map((h, i) => (
                <div key={i} className="glass-card p-4 rounded-lg group hover:border-primary/30 transition-all duration-300">
                  <h.icon size={20} className="text-primary mb-2 group-hover:drop-shadow-[0_0_8px_hsl(190,100%,50%,0.5)] transition-all" />
